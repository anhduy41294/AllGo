package com.kun.allgo.FaceIdentification;
...
public class PersonGroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Set<String> personGroupIds = StorageHelper.getAllPersonGroupIds(PersonGroupActivity.this);
        if (personGroupIds.isEmpty()) {
            createNewPersonGroup();
        } else {
            for (String id:personGroupIds) {
                setupPersonGroup(id);
            }
        }
...
//        personGroupExists = true;
    ...
    private void setupPersonGroup(String Id) {
        addNewPersonGroup = false;
        oldPersonGroupName = "AllGoGroup";
        personGroupId = Id;
        personGroupExists = true;
